...
const AddQuery = () => {
  ...
  const submitQuery = async (e) => {
   ...
   const res= await axios.post("http://localhost:3000/api/query", {Id, message,month},
      {
          headers: {
  ...
  <div className="bg-white p-8 rounded-md shadow-md w-full max-w-xl">
    <h2 className="text-2xl font-bold mb-6 text-center">Raise Salary Query</h2>
    <form onSubmit={submitQuery}>
      ...
      <div className="mb-4">
        <label className="block mb-1 font-semibold">Describe your salary issue</label>
        <textarea
          className="w-full border border-gray-300 p-2 rounded"
          rows="4"
