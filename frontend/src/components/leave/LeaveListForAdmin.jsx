...
const LeaveHistoryForAdmin = () => {
  ...
  const fetchLeaves = async () => {
    try {
      const response = await axios.get(
        `http://localhost:3000/api/leave/leaveForAdmin/${id}`,
        {
          headers: {
  ...
  return (
    <div className="bg-white p-4 rounded shadow m-8">
      <h3 className="text-2xl text-center font-semibold mb-2">Leave History</h3>
